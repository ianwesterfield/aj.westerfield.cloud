...
def parse_args():
    parser = argparse.ArgumentParser(description="Validation training for context switching")
    parser.add_argument("--model", type=str, default="Qwen/Qwen2.5-1.5B-Instruct",
                        help="Base model to fine-tune")
    parser.add_argument("--data", type=str, default="../data/context_switching.jsonl",
                        help="Path to context_switching.jsonl")
    parser.add_argument("--output", type=str, default="../models/context-switching-validation",
